...
function bestFilmOfYear(array) {
  let sortPerScore = [...array]
  sortPerScore.sort((a,b) => a.score > b.score ? -1 : 1);
  let bestOfEachYear = []
  bestOfEachYear = sortPerScore.filter((film, index, arr) => {
   arr.includes(film.year) ? false : true 
  })
  return bestOfEachYear;
}

//best of one year
function bestFilmOfYear2(array, year) {
...
function bestFilmOfYear3(array, year) {
  let sortPerScore = [...array]
  sortPerScore.sort((a,b) => a.score > b.score ? -1 : 1);
  return sortPerScore.find(film => film.year == year)
}

//console.table(bestFilmOfYear2(movies,2021))
